# HiFi Collective Tweeter Index — Raw Spec Reference
Scanned June 2026 from hificollective.co.uk. Specs pulled from individual product pages.

**Prices:** Product pages list ex-VAT (+ VAT applies). Shop listing pages (Scanspeak) may already include VAT — marked *. UK VAT = 20%.

**Status codes:** ★ new candidate not in SI index | ≡ also in SI index (UK source note) | ~ weak/concern | ✗ rejected | OOS | DISC | ? need fetch
...
| Scanspeak D3004/664000 | Dome (Beryllium) | ? | £342.03* | OOS | ? | ? | ? | ? | ~26 | ? | ✗ OOS; way too expensive |
| Viawave GRT-145-4 | Ribbon (pair) | 4Ω | £520/pair | ? | ? | ? | ? | — | — | ? | ✗ £312+/unit ex-VAT — far exceeds budget |
| Viawave GRT-145-8 | Ribbon (pair) | 8Ω | £520/pair | ? | ? | ? | ? | — | — | ? | ✗ £312+/unit ex-VAT — far exceeds budget |
| Viawave SRT-7 | Ribbon (pair) | 8Ω | £520/pair | ? | ? | 95 | ? | 104 | — | 4,000+ | ✗ £312+/unit ex-VAT; 4–18kHz only |

---

## Discontinued — HiFi Collective Legacy Stock

| Model | Type | Imp | Notes |
| ----- | ---- | --- | ----- |
| Morel MDT-22 | Dome (Neo) | 8Ω | DISC |
| Morel MDT-29 | Dome | ? | DISC — superseded by CAT-298 |
| Morel MDT-32-S | Dome | ? | DISC |
| Morel MDT-33 | Dome | ? | DISC |
| Morel CAT-308 | Dome | ? | DISC — replaces MDT-30 |
| Jantzen JA-2806 | Dome | 6Ω | DISC; Fs=700Hz; 91dB; good Fs when active |
| Jantzen JDT-1024 | Dome (diamond) | 8Ω | DISC; Fs=1,030Hz; 91dB; 30W only |
| SEAS 27TAFC/G H0883-06 | Dome (Al) | 6Ω | DISC |
| SEAS 27TBFC/G H1212-06 | Dome | 6Ω | DISC |
| SEAS 27TFF/TV H0857-06 | Dome (shielded) | 6Ω | DISC; TV-shielded |
| SEAS 27TTFNC/GW H1461-06 | Dome | 6Ω | DISC |
| SEAS 25TAFN/QG H0623 | Dome (Neo) | ? | DISC |
| SEAS 25TFFC H0519-06 | Dome | 6Ω | DISC |
| SEAS 25TFFN/QG H0625-06 | Dome | 6Ω | DISC |
| SEAS 19TFF1 H0737-08 | Dome | 8Ω | DISC; 19mm |
| Audax TM020J7 | Dome (Ti) | ? | DISC; titanium |
| Audax TM025F7 | Dome (Ti) | ? | DISC; titanium |

---

## Excluded — Wrong Application / Out of Project Scope

| Model | Reason |
| ----- | ------ |
| SEAS T35C002 E0055-06 | 35mm dome midrange; £276 ex-VAT — wrong role, too expensive |
| Fostex FT17H / T360FD / T90A / T96A-SA / T925A / T900A / T500A MKIII | Horn or super-tweeters (≥5kHz); wrong application |
| Aurum Cantus G2Si | Ribbon pair; no price obtained; specialist application |
| Mundorf AMT (U.Series / Concert / Dipole) | AMT; sub-categories not fully explored; note for future if AMT is reconsidered |
| Morel Ruark Solus replacement | Specific speaker replacement part |
