...
| `solutions.html` | Curated final report rendered as a styled HTML file with tabbed scenarios, seller badges showing prices, and direct buy links. | Exhaustive lists, marginal options, runner-ups beyond 5th place |
